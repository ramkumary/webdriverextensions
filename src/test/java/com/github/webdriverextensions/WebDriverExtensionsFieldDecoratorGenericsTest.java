...
public class WebDriverExtensionsFieldDecoratorGenericsTest {
	...
	public void testPassingTypeArgumentInListToTypeVariableInList() {
		open(url);
		assertTextEquals("typeArgumentInList.get(0).typeVariableInList.get(0).text",
				typeArgumentInList.get(0).typeVariableInList.get(0).text);
		assertTextEquals("typeArgumentInList.get(1).typeVariableInList.get(1).text",
				typeArgumentInList.get(1).typeVariableInList.get(1).text);
		assertTextEquals("typeArgumentInList.get(0).typeVariableInList.get(0).text",
				typeArgumentInList.get(0).typeVariableInList.get(0).text);
		assertTextEquals("typeArgumentInList.get(1).typeVariableInList.get(1).text",
				typeArgumentInList.get(1).typeVariableInList.get(1).text);
