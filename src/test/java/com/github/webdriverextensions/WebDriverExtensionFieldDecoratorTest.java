...
public class WebDriverExtensionFieldDecoratorTest extends TestWebRepository {
	...
	@Test
	public void anyElementCanBeFindUsingTagAndAttributesOrDisplayTest() {
		WebElement elementSearchQuery = BotUtils.findElementFirstOrDefault(ElementTag.INPUT, "id", "search-query");
		WebElement elementSearch = BotUtils.findElementFirstOrDefault(ElementTag.BUTTON, "Search");
		if (elementSearch != null && elementSearchQuery != null) {
			Bot.clearAndType("Mark", elementSearchQuery);
			Bot.click(elementSearch);
		}
	}
}
