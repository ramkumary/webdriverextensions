...
public class BotTest extends TestWebRepository {
	...
	/* Open */
	@Test
	@IgnoreSafari // throws UnsupportedCommandException from RemoteWebElement.isDisplayed() for
					// some reason
	...
	public void classTest() {
		...
		Assert.assertThat(classIn(botTestPage.attributesSpan),
				equalTo(" prefixclass1suffix prefixclass2suffix prefixclass3suffix "));
